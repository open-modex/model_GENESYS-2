...
- (0.3) Add the distribution to the virtual box clicking on 'New' (Neu) and setting the Version to Red Hat (64-Bit). CHOOSE INSTALLATION WITH GNOME DESKTOP AND SUBFILES <br/>
